...
<template>
    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="max-w-7xl mx-auto mt-10 p-6 lg:p-8 overflow-hidden bg-gradient-to-b from-slate-200 to-gray-100 dark:from-gray-700 dark:to-gray-900 rounded-lg">            
                ...
                class="flex justify-center  before:bg-gradient-to-t before:from-teal-500/70 before:via-fuchsia-600 before:to-transparent before:blur-xl before:filter">
                    <h1 class="title text-6xl font-black text-blue-900 dark:text-green-500">Info</h1>
                    <h2 class="cursive text-6xl font-thin text-green-500 dark:text-cyan-300">Sport</h2>                    
                </div>
                <div class="mt-10">
                    ...
                    <br>
                    <p hidden class="text-gray-600 dark:text-gray-300 md:block">
                        La asociación ha organizado numerosos torneos locales que fortalecen los lazos comunitarios y brindan una plataforma para exhibir habilidades futbolísticas. Su enfoque inclusivo se traduce en un espacio donde la pasión por el deporte se fusiona con la camaradería. Más allá del campo de juego, la asociación está comprometida con programas de responsabilidad social, empoderando a jóvenes mediante iniciativas educativas y de desarrollo personal.
                    </p>
                </div>
            </div>
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    <a
                        ...
                        <svg 
                            ...
                            viewBox="0 0 640 512"
                            stroke-width="1.5"
                            class="-mt-px mr-1 w-5 h-5 fill-gray-400 dark:fill-gray-600 group-hover:fill-gray-600 dark:group-hover:fill-gray-400"
                    ...
                    Desarrollado por Joel Mamani Yapu
                    </a>
                </div>
            </div>
        </div>
