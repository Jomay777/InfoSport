      ...
      <div class=" mt-5 flex flex-col justify-center items-center ">
            <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-gray-100 bg-clip-border shadow-3xl shadow-shadow-500 p-3">
                <div class="mt-2 mb-8  text-gray-700 w-full">
                    <h4 class=" mt-5 px-2 text-2xl font-bold text-navy-700 ">
                    Rol de partido {{ game_role.name }}
                    </h4>                    
                </div> 
                <div class="grid grid-cols-2 gap-4 px-2 w-full">
                    <div class="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-1 shadow-3xl shadow-shadow-500 ">
                    ...
                    <div class="flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-1 shadow-3xl shadow-shadow-500 ">
                    ...
                    <p v-if="game_role.pitch" class="text-base font-medium text-navy-700 ">
                    ...
                    <p v-if="game_role.tournament" class="text-base font-medium text-navy-700 ">
                ...
                <div class="mt-3 mb-8 px-2 w-full" v-if="game_role.game_schedulings">
                  <div v-for="game_scheduling in sortedGameSchedulings" :key="game_scheduling.id"
                    class="mt-3 rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 ">
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <Modal :show="showConfirmDeleteGameRoleModal" @close="closeModal">
                        <div class="p-6">
                            <h2 class="text-lg font-semibold text-slate-800 ">¿Está seguro de eliminar el rol de partidos {{ game_role.name }}?</h2>
