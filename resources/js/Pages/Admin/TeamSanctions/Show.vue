    ...
    <div class="max-w-7xl mx-auto py-4">
      ...
      <div class=" mt-5 flex flex-col justify-center items-center ">
            <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-gray-100 bg-clip-border shadow-3xl shadow-shadow-500 p-3">
                ...
                <div class="mt-5 px-2 w-full">
                  <p class="text-xl text-gray-700 ">Obsevación</p>
                  <div class="mt-3 flex justify-center">
                    <p class="text-base font-medium text-navy-700 ">
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <Modal :show="showConfirmDeleteTeamSanctionModal" @close="closeModal">
                        <div class="p-6">
                            <h2 class="text-lg font-semibold text-slate-800 ">¿Está seguro de eliminar la sanción del equipo {{ team_sanction.team.name }}</h2>
