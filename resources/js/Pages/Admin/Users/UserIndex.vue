    ...
    methods: {
      async searchUser() {
        ...
        if(this.search.length > 0){
          await this.$inertia.get(route('users.index', { search: this.search }));
        }else{
          await this.$inertia.get(route('users.index'));
        }
...
const showConfirmDeleteUserModal = ref(null)

const confirmDeleteUser = (id) => {
      showConfirmDeleteUserModal.value = id;
}

const closeModal = () => {
  showConfirmDeleteUserModal.value = null;
}
      ...
      <div class="flex space-x-4">
        ...
        <div class="md:block">
          <div class="relative flex items-center text-gray-400 focus-within:text-cyan-400">                        
            ...
            type="search" name="search" id="search" placeholder="Buscar usuario" 
            ...
            <button @click.prevent="searchUser" class="absolute left-4 h-6 flex items-center pr-3 border-r border-gray-300">
            ...
            <TableRow v-for="user in users" :key="user.id" class="border-b">
              ...
              <TableDataCell class="space-x-4">
               ...
               <Modal :show="showConfirmDeleteUserModal === user.id" @close="closeModal">
                 <div class="p-6">
                  <h2 class="text-lg font-semibold text-slate-800 dark:text-white">¿Está seguro de eliminar al usuario {{ user.name }} ?</h2>
