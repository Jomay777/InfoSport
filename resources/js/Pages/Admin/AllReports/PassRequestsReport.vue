...
const types = ref([{'id': 5,'name':'Solicitud de pases', route: 'pass_requests'}
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="report?.id == 5" class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg -z-10">
                    ...
                    :options="{responsive:true, autoWidth:false,dom:'Bfrtip',buttons:buttons5,select:true,language: language}">
                    <thead>
