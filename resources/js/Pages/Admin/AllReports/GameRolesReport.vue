...
const report = ref([]);
const types = ref([{id: 8, name:'Roles de partidos', route: 'game_roles'}
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="report?.id == 8" class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg -z-10">
                    ...
                    :options="{responsive:true, autoWidth:false,dom:'Bfrtip',buttons:buttons8,select:true,language: language}">
                    <thead>
