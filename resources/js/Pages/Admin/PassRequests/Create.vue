...
const storePassRequest = () =>{
  form.post(route('pass_requests.store'));
}
...
<template>
  <Head title="Crear nueva solicitud de pase" />
  ...
  <AdminLayout>
    <div class="max-w-7xl mx-auto py-4">
      ...
      <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
        <h1 class="text-2xl font-semibold text-indigo-700">Crear nueva solicitud de pase</h1>
        <form @submit.prevent="storePassRequest" enctype="multipart/form-data">
          <div class="mt-4">
          ...
          <div class="mt-4">
            ...
            <input type="file" id="request_photo_path" @change="handleFileChange" required/>
          </div>
