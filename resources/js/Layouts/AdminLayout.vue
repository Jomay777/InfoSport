  ...
  <div class="overflow-y-auto overflow-x-hidden">
        ...
        <ul class="space-y-2 tracking-wide mt-8">
            ...
            <li v-if="hasPermission('Ver jugador')">
                ...
                <svg xmlns="https://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
            ...
            <li v-if="hasPermission('Ver pase')">
                ...
                <svg xmlns="https://www.w3.org/2000/svg" height="17" width="14" viewBox="0 0 384 512"> 
            ...
            <li>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 384 512">
                    <path fill="#030303" d="M0 448c0 35.3 28.7 64 64 64H224V384c0-17.7 14.3-32 32-32H384V64c0-35.3-28.7-64-64-64H64C28.7 0 0 28.7 0 64V448zM171.3 75.3l-96 96c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l96-96c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6zm96 32l-160 160c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l160-160c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6zM384 384H256V512L384 384z"/>
                </svg>
            ...
            <li>
                ...
                :active="route().current('player_sanctions.*')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5" />
                </svg>

                <span class="-mr-1 font-medium">Sanción de Jugadores</span>
                </SidebarLink>
            </li>
            <li>
                <SidebarLink
                :href="route('team_sanctions.index')" 
                :active="route().current('team_sanctions.*')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5" />
                </svg>

                <span class="-mr-1 font-medium">Sanción de Equipos</span>
                </SidebarLink>
            </li>
        </ul>
    </div>
...
<!--                     <Link rel="stylesheet" href="#" onclick="location.reload();">
 -->                        
                    <Link rel="stylesheet" :href="route('administration.index')" >
